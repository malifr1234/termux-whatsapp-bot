...
const ow = 'malifr12';
const nomorowner = '081284112634';
const ovo = '081284112634';
const pulsa = '081284112634';
const dana = '';
const instagram = 'http://';
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
  + 'VERSION:3.0\n'
  + 'FN: malifr12\n' // Nama kamu
  + 'ORG:Selif;\n' // Nama bot
  + 'TEL;type=CELL;type=VOICE;waid=6282223014661:+62 812-8411-2634\n' //Nomor whatsapp kamu
  + 'END:VCARD'
//
const
  {
...
setInterval(function () {
  for (i = 0; i < 3; i++) {
    console.log(`[ ${moment().format("HH:mm:ss")} ] => HI! I'm Selif:)`)
  }
}, 15000)
